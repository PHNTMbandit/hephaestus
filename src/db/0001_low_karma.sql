CREATE TABLE "color_palettes" (
	...
	CONSTRAINT "color_palettes_user_id_name_key" UNIQUE("user_id","name")
);
...
ALTER TABLE "color_palettes" ADD CONSTRAINT "color_palettes_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "design_systems" ADD CONSTRAINT "design_systems_color_palette_id_fkey" FOREIGN KEY ("color_palette_id") REFERENCES "public"."color_palettes"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "color_palettes_user_id_idx" ON "color_palettes" USING btree ("user_id");--> statement-breakpoint
...
CREATE POLICY "select own color palettes" ON "color_palettes" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "insert own color palettes" ON "color_palettes" AS PERMISSIVE FOR INSERT TO public;--> statement-breakpoint
CREATE POLICY "update own color palettes" ON "color_palettes" AS PERMISSIVE FOR UPDATE TO public;--> statement-breakpoint
CREATE POLICY "delete own color palettes" ON "color_palettes" AS PERMISSIVE FOR DELETE TO public;--> statement-breakpoint
