...
import { getConformanceStatus } from '#/features/accessibility/utils/conformance'
...
import type { ContrastRequirementPreview } from '#/features/accessibility/types/algorithm'
